...
const InputsFormNode = ({
  ...
  return (
    <div className={cn('mb-6 flex flex-col items-center px-4 pt-6', isMobile && 'mb-4 pt-4')}>
      <div className={cn(
        'w-full max-w-[800px] rounded-2xl border-[0.5px] border-components-panel-border bg-components-panel-bg shadow-md',
      ...
      {collapsed && (
        <div className='flex w-full max-w-[1000px] items-center py-4'>
